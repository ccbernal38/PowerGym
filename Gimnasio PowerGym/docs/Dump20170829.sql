...
CREATE TABLE `caja` (
  ...
  CONSTRAINT `fk_caja_usuario` FOREIGN KEY (`usuario_id_apertura`) REFERENCES `usuario` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION,
  CONSTRAINT `fk_caja_usuario1` FOREIGN KEY (`usuario_id_cierre`) REFERENCES `usuario` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `usuario` VALUES (1,'ccbernal38','123456','1094925466','Christian','Camilo','Bernal','Rojas','Bernal@powergym.com','3153946037',1,'1992-01-19','Guaduaels de la villa','2017-08-24 00:22:13','2017-08-24 00:22:28');
...
-- Dump completed on 2017-08-29 21:28:49
